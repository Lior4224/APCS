...
{    
  ...
  public static int Fast (int arr[], int y, int start, int end) {
      if (y >= end) {
          return arr[y];
      }
      int rand = (int)((Math.random() * end) + start);
      int pivot = splitter(arr, start, end, rand);

      if (pivot == y) {
          return arr[pivot];
      }
      else if (pivot < y) {
          return Fast(arr, y, pivot, end);
      }
      else {
          return Fast(arr, y, start, pivot);
      }
  }
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println(Fast(arr1, 2, 0, 4));
    System.out.println(Fast(arr1, 3, 0, 4));
    System.out.println(Fast(arr3, 2, 0, 4));
    System.out.println(Fast(arr4, 2, 0, 4));
    System.out.println(Fast(arr5, 2, 0, 4));
    System.out.println(Fast(arr6, 2, 0, 4));
   }
